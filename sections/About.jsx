    ...
    <section className={`${styles.paddings} relative z-10`}>
        ...
        >
            ...
            <motion.p
                ...
                className="mt-[8px] font-normal sm:text-[32px] text-[14px] text-center text-secondary-white"
            >
                ...
                it's really real, you can feel what you feel in this metaverse world, because this
                is really the
